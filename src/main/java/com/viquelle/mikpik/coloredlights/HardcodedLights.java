...
public final class HardcodedLights {
    ...
    static {
        ...
        LIGHTS.put(Blocks.SMALL_AMETHYST_BUD, new LightData(0xCFB0FF, 1f, 3.5f, false));
        LIGHTS.put(Blocks.MEDIUM_AMETHYST_BUD, new LightData(0xCFB0FF, 2f, 3.5f, false));
        LIGHTS.put(Blocks.LARGE_AMETHYST_BUD, new LightData(0xCFB0FF, 2.5f, 3.5f, false));
        LIGHTS.put(Blocks.AMETHYST_CLUSTER, new LightData(0xCFB0FF, 3.5f, 3.5f, false));
